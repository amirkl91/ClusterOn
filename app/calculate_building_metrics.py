...
if __name__ == "__main__":
    ...
    streets, intersections = pp.get_streets(
        streets=streets, local_crs=local_crs, get_nodes=True
    )
    ...
    tesselations, enclosures = pp.get_tessellation(
        buildings=buildings, streets=streets, tess_mode="enclosed", clim="adaptive"
    )
